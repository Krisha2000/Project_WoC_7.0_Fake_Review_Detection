...
svm_model = st.file_uploader("SVM_model", type=["pkl"])
word2vec_model = st.file_uploader("word2Vec_model", type=["model"])
...
# getting user input of product link
    ...
    if not reviews.empty:
        ...
        try:
            if "Review Text" in reviews.columns and "Rating" in reviews.columns:
                ...
                # Geting predictions based on selected model
                model_dict = {
                ...
                # Plotling Pie Chart for Selected Model
